        ...
        <div className="container w-2/3 p mx-auto mt-20 rounded-xl">
            <div>
                <div className="flex justify-center bg-cyan-0 rounded-xl mb-2">
                    <h5 className="w-fit px-11 text-black">Stock Management Control Panel</h5>
                </div>
                <div className="flex flex-row justify-start mb-2">
                    ...
                    <button className="flex align-center justify-center items-center" title="Crear Nuevo Registro">
                        <Link to={"/create_book"}>
                            ...
                            filteredBooks.map((book, index) => {
                                return (
                                    <tr
                                        ...
                                        key={index + 1}
                                    >
                                        <td className="flex align-center justify-center content-center">{index + 1}</td>
