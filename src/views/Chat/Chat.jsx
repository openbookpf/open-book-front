...
function Chat() {
  ...
  return isAuthenticated ? (
    <div className="flex flex-col items-center h-screen">
      ...
      <div className="grow bg-[#fef3ed] mv:w-screen sm:w-5/6 shadow-xl flex flex-col mb-5 text-xl overflow-auto rounded-xl pt-2">
        <div className="flex ml-4 mb-2">
          <FaUser
            ...
            className={
              users.length ? "text-lg text-cyan-0" : "text-lg text-gray-600"
            }
          />
              ...
              <div className={msg.user ? null : "flex justify-center"}>
                ...
                >
                  ...
                  <div className="flex items-end">
                    <div
                      className={
                        msg.user ? "grow text-lg" : "grow text-sm text-center"
                      }
                    >
                      {msg.message}
                    </div>
      ...
      {showUsers ? (
        <ShowAllUsers setShowUsers={setShowUsers} users={users} />
      ) : null}
    </div>
  ) : (
