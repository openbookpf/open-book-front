    ...
    <div className="relative ">
      ...
      <footer>
        <div className="relative dark:bg-gray-800">
          <div className="mt-20 mb-2 ml-12 font-bold text-2xl pb-5 dark:bg-gray-800">
            <p className="underline decoration-4 underline-offset-8 dark:text-white-0 decoration-cyan-0">
              Best sellers
            </p>
          </div>
