...
const Checkout = () => {
    ...
    return (
        cartItems?.length && (
            <div className="font-poppins md:container md:mx-auto w-full min-h-screen min-w-screen  mt-20 flex flex-col">
                <div className="flex h-full w-full items-center justify-center bg-orange-20 mt-10 mb-10">
                    <div className="w-80 rounded px-6 pt-8 shadow-lg">
                        <img src={openBookLogo} alt="chippz" className="mx-auto w-1/2 py-4" />
                            ...
                            <table className="w-full text-left">
                                ...
                                <tbody>
                                    ...
                                    <tr className="flex py-1">
                                        ...
                                        <td className="min-w-[44px] font-bold ">{`$${cartTotalPrice.toFixed(2)}`}</td>
                                    </tr>
                                </tbody>
                            </table>
