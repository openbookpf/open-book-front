...
function Detail() {
    ...
    const apiUrl = `https://open-book-back.onrender.com/book/bookId/${isbn.replace(/\D/g, "")}`;
    ...
    const { book_cover_url, book_title, author, price, book_description, genre } = bookData;
