...
const ShowFilterByGenre = () => {
  ...
  return (
    <div className="relative flex flex-col w-screen bg-blue-1">
      <div
      ...
      ></div>
      <div className="relative bg-slate-50 mx-6 rounded-xl mt-24 flex flex-row">
        <div className="flex-col w-72 pr-10 bg-[#fef3ed] shadow-lg rounded-xl h-min pb-10 ml-5 mt-5">
          <p className="text-xl font-bold mt-4 mx-5">Authors</p>
          <div className="flex flex-col items-start mt-3 ml-10 leading-6 ">
            {authors.map((author) => (
              <button
                key={author}
                className={
      ...
      <footer className="relative flex items-center text-center justify-center my-4 py-2">
        <div className="text-lg w-screen px-10 text-white-0 font-semibold rounded-full h-12 flex items-center justify-center">
          <Paginator
            className="text-white-0 mx-6 px-20 border-white-1 border-4 rounded-xl"
            first={first}
            rows={rows}
