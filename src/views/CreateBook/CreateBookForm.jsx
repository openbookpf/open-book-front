...
const CreateBookForm = () => {
    ...
    const handleCloseTag = (event) => {
        ...
        setBookData({ ...bookData, genre: [...bookData.genre].filter((fil) => fil !== value) });
            ...
            >
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="w-5/6 flex mt-3 duration-200">
                        ...
                        >
                            <MdError className={errorForm.ISBN ? "text-orange-0 ml-1" : "hidden"} />
                        </div>
                    ...
                    <div className="w-5/6 flex mt-3">
                        ...
                        <div
                            ...
                            className="flex justify-center items-center"
                        >
                            <MdError className={errorForm.book_title ? "text-orange-0 ml-1" : "hidden"} />
                        </div>
                    ...
                    <div className="w-5/6 flex mt-3">
                        ...
                        <div
                            ...
                            className="flex justify-center items-center"
                        >
                            <MdError className={errorForm.author ? "text-orange-0 ml-1" : "hidden"} />
                        </div>
                    ...
                    <div className="w-5/6 flex mt-3">
                        ...
                        <div
                            ...
                            className="flex justify-center items-center"
                        >
                            <MdError className={errorForm.editorial ? "text-orange-0 ml-1" : "hidden"} />
                        </div>
                    ...
                    <div className="flex items-center justify-start w-5/6">
                        ...
                        <div className="w-64 flex items-center mt-3">
                            ...
                            <select
                                ...
                                className={
                                    errorForm.lenguage ? "border-2 border-orange-0 rounded-xl" : "border-2 rounded-xl"
                                }
                            >
                        ...
                        <div className="grow flex items-center mt-3">
                            ...
                            <div
                                ...
                                className="flex justify-center items-center"
                            >
                                <MdError className={errorForm.year_of_edition ? "text-orange-0 ml-1" : "hidden"} />
                            </div>
                    ...
                    <div className="flex flex-col mt-3 w-5/6 ">
                        <div className="w-5/6 flex flex-row items-center">
                            ...
                            <div
                                ...
                                className="flex justify-center items-center"
                            >
                                <MdError className={errorForm.genres ? "text-orange-0 ml-1" : "hidden"} />
                            </div>
                        ...
                        <div className="bg-gray-50 h-14 border-2 rounded-xl mt-2 flex items-center px-2 justify-around">
                            {bookData.genre.length ? null : (
                                <p className="text-gray-400 ml-3 mt-1">You can add three genres per book</p>
                            )}
                            {bookData.genre.map((gen) => (
                                <div className="flex px-2 py-1 justify-between items-center w-48 rounded-full border-2 border-gray-400">
                    ...
                    <div className="flex flex-col w-5/6 mt-3">
                        <div className="flex font-semibold">
                            ...
                            <div
                                ...
                                className="flex justify-center items-center"
                            >
                                <MdError className={errorForm.book_description ? "text-orange-0 ml-1" : "hidden"} />
                            </div>
                    ...
                    <div className="w-5/6 flex mt-3">
                        ...
                        <div
                            ...
                            className="flex justify-center items-center"
                        >
                            <MdError className={errorForm.price ? "text-orange-0 ml-1" : "hidden"} />
                        </div>
                    ...
                    <div className="w-5/6 flex mt-3">
                        ...
                        <div
                            ...
                            className="flex justify-center items-center"
                        >
                            <MdError className={errorForm.img ? "text-orange-0 ml-1" : "hidden"} />
                        </div>
