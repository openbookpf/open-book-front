...
const Searchbar = ({ setTrigger }) => {
  ...
  return (
    <div className="z-30 container w-full h-full fixed top-0 left-0 bg-black bg-opacity-20 flex align-center justify-center content-center border border-black ">
      <div className="container w-1/2 h-max flex flex-col border border-black rounded-lg bg-[#3D405B] mx-auto mt-20 ">
        ...
        <div className="w-full f">
          <div className="flex px-20" style={{ height: "100%", width: "100%" }}>
        ...
        <div className="flex w-full items-center justify-center content-center">
          {searchbooks?.length ? (
            ...
            <div className="h-[250px] flex flex-col items-center content-center justify-center text-white-0">
