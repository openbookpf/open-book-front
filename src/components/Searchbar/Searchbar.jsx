...
const Searchbar = ({ setTrigger }) => {
    ...
    return (
        ...
        <div className="z-30 w-screen h-screen fixed bg-black bg-opacity-30">
            <div className=" mv:w-[300px] sm:w-80 md:w-[800px] h-max flex flex-col border-black rounded-lg bg-[#fef3ed] bg-opacity-95 mx-auto mt-20 shadow-2xl">
                ...
                <div className="w-full">
                    <div
                        className="mv:flex md:hidden justify-center"
                        // style={{ height: "100%", width: "100%" }}
                    >
                        {searchbooks &&
                            searchbooks.slice(0, 1).map((book, index) => {
                                return (
                                    <div
                                        className="scale-90"
                    ...
                    <div
                        className="md:flex mv:hidden justify-center"
                        // style={{ height: "100%", width: "100%" }}
                    >
                        {searchbooks &&
