...
const Libros = () => {
  ...
  const cantidadPaginas = Math.ceil(libros.length / librosPorPagina);
    ...
    <div className="container mx-auto">
      ...
      <div className="mt-8 flex justify-between">
        <button
          ...
          className="px-4 py-2 bg-orange-400 text-gray-700 rounded-md transition duration-300 ease-in-out hover:bg-orange-300 hover:text-white"
        >
          Previous
        </button>
        <button
