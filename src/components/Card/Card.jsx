        ...
        >
            <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col text-black mx-auto mt-12 pt-2 px-5 w-full">
                    ...
                    <p className="font-semibold text-lg">${`${book.price.toFixed(2)} (USD)`}</p>
                </div>
            </div>
            <div className="flex flex-row items-center mx-auto gap-1.5 ">
                <Link to={isAuthenticated ? "/checkout" : "#"}>
                    ...
                    >
                        <span className="text-white-0 align-middle py-2 px-4 text-sm  rounded-md flex justify-center items-center">
                            BUY NOW
                        </span>
                    </button>
                </Link>
