    ...
    return (
        <div>
                            ...
                            {showLinks ? (
                                <div className="absolute top-20 left-20">
                                    <div className="flex flex-col bg-white-1 p-3 rounded-xl shadow-xl">
                                        <Link to="/books" className="py-1 px-2 rounded-lg " onClick={handleShowLinks}>
                                            Books
                                        </Link>
                                        <Link to="/aboutus" className="py-1 px-2 rounded-lg " onClick={handleShowLinks}>
                                            About Us
                                        </Link>
                ...
                <div className="flex flex-row mr-4 gap-6">
                    ...
                    {isAuthenticated ? (
                        ...
                        <div className="flex flex-row mv:mr-0 sm:mr-8 gap-5">
                            <Link to="/cart" className="text-black relative align-middle my-auto ">
            ...
            <div className="fixed z-20 end-2 mt-2">
                <Select setSelectMenuOpen={setSelectMenuOpen} selectMenuOpen={selectMenuOpen} />{" "}
            </div>
        </div>
    );
};
