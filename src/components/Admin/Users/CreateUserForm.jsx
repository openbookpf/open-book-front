...
const CreateUserForm = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-b from-blue-1 to-orange-0">
        ...
        >
          ...
          <div className="flex flex-col items-center">
            <div className="w-5/6 flex mt-3">
              ...
              >
                <MdError
                  className={errorForm.email ? "text-orange-0 ml-1" : "hidden"}
                />
              </div>
              ...
              <div className="grow">
                <div className="flex">
                  ...
                  >
                    <MdError
                      className={
                        errorForm.password ? "text-orange-0 ml-1" : "hidden"
                      }
                    />
                  </div>
            ...
            <div className="w-5/6 flex mt-3">
              ...
              <div>
                ...
                >
                  <MdError
                    className={
                      errorForm.user_type ? "text-orange-0 ml-1" : "hidden"
                    }
                  />
                </div>
                <Tooltip className="text-xs" id="password-tooltip" />
